...
import { ModStorage, modStorage, DeviousPadlockProfile, syncStorage } from "@/modules/storage";
...
export class DeviousPadlockSettingsSubscreen extends BaseSubscreen {
    private padlockSettings: DeviousPadlockSettings;
    private readonly sourcePadlockSettings: DeviousPadlockSettings;
        ...
        this.saveButtonElement = this.createButton({
            ...
            onClick: async () => {
                if (this.mode === "inspect-padlock") {
                    ...
                    console.log("Update config to save", updateConfig);
